...
/*	connection cc("dbname = cars user = postgres password = postgres \
    ...
    svr.Get("/api/v1/trailers", MatchesRoute::Get()->GetTrailers());
    ...
    svr.Get("/api/v1/match/lineups_stats", MatchesRoute::Get()->GetMatchLineupsStats());
    ...
    svr.Get("/api/v2/match/fireball/top20", PredictsRoute::Get()->GetMatchFireballTop20V2());
